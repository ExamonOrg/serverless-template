...
data "aws_lambda_function" "get_questions_lambda" {
...
module "api_gateway_v2_get_questions" {
  ...
  path                      = "/questions"
  stage_name                = "staging"
  integration_uri           = data.aws_lambda_function.get_questions_lambda.invoke_arn
  function_name             = data.aws_lambda_function.get_questions_lambda.function_name
